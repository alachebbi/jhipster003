...
# Reclamation e-mail
email.reclamation.title=Activació <%= baseName %>
email.reclamation.greeting=Benvolgut {0}
email.reclamation.text1=S
email.reclamation.text2=Salutacions,
email.reclamation=<%= baseName %>.
email.reclamation.text1=El seu compte a <%= baseName %> ha estat creat, si us plau cliqueu l'enllaç de sota per accedir-hi:
