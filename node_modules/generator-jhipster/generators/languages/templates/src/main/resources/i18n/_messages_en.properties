...
# Reclamation e-mail
email.reclamation.title= account activation
email.reclamation.greeting=Dear {0}
email.reclamation.text1=Your <%= baseName %> account has been created, please click on the URL below to activate it:
email.reclamation.text2=Regards,
