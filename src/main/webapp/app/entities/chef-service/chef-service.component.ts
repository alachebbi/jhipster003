...
export class ChefServiceComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: ChefService) {
        return item.id;
    }
    ...
    registerChangeInChefServices() {
        this.eventSubscriber = this.eventManager.subscribe('chefServiceListModification', (response) => this.loadAll());
    }
