...
export class ChefServiceService {
    ...
    private resourceUrl = 'api/chef-services';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(chefService: ChefService): Observable<ChefService> {
        let copy: ChefService = Object.assign({}, chefService);
    ...
    update(chefService: ChefService): Observable<ChefService> {
        let copy: ChefService = Object.assign({}, chefService);
        copy.datedenaissance = this.dateUtils
            .convertLocalDateToServer(chefService.datedenaissance);
    ...
    find(id: number): Observable<ChefService> {
