...
export class DemandematerielComponent implements OnInit, OnDestroy {

currentAccount: any;
    demandemateriels: Demandemateriel[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Demandemateriel) {
        return item.id;
    }



    registerChangeInDemandemateriels() {
        this.eventSubscriber = this.eventManager.subscribe('demandematerielListModification', (response) => this.loadAll());
    }
