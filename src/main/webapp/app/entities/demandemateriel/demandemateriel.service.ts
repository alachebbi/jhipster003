...
export class DemandematerielService {
    ...
    private resourceUrl = 'api/demandemateriels';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(demandemateriel: Demandemateriel): Observable<Demandemateriel> {
        let copy: Demandemateriel = Object.assign({}, demandemateriel);
    ...
    update(demandemateriel: Demandemateriel): Observable<Demandemateriel> {
        let copy: Demandemateriel = Object.assign({}, demandemateriel);
        copy.date = this.dateUtils
            .convertLocalDateToServer(demandemateriel.date);
    ...
    find(id: number): Observable<Demandemateriel> {
