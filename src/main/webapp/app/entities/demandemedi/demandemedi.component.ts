...
export class DemandemediComponent implements OnInit, OnDestroy {

currentAccount: any;
    demandemedis: Demandemedi[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Demandemedi) {
        return item.id;
    }



    registerChangeInDemandemedis() {
        this.eventSubscriber = this.eventManager.subscribe('demandemediListModification', (response) => this.loadAll());
    }
