...
export class DemandemedicamentComponent implements OnInit, OnDestroy {
...
currentAccount: any;
   ...
   bb(i:Demandemedicament)
    ...
    trackId (index: number, item: Demandemedicament) {
        return item.id;
    }



    registerChangeInDemandemedicaments() {
        this.eventSubscriber = this.eventManager.subscribe('demandemedicamentListModification', (response) => this.loadAll());
    }
