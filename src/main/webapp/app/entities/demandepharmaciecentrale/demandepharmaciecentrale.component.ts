...
export class DemandepharmaciecentraleComponent implements OnInit, OnDestroy {

currentAccount: any;
    demandepharmaciecentrales: Demandepharmaciecentrale[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Demandepharmaciecentrale) {
        return item.id;
    }



    registerChangeInDemandepharmaciecentrales() {
        this.eventSubscriber = this.eventManager.subscribe('demandepharmaciecentraleListModification', (response) => this.loadAll());
    }
