...
export class DossierMedicalVFComponent implements OnInit, OnDestroy {

currentAccount: any;
    dossierMedicalVFS: DossierMedicalVF[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: DossierMedicalVF) {
        return item.id;
    }
    ...
    registerChangeInDossierMedicalVFS() {
        this.eventSubscriber = this.eventManager.subscribe('dossierMedicalVFListModification', (response) => this.loadAll());
    }
