...
export class DossierMedicalService {
    ...
    private resourceUrl = 'api/dossier-medicals';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(dossierMedical: DossierMedical): Observable<DossierMedical> {
        let copy: DossierMedical = Object.assign({}, dossierMedical);
    ...
    update(dossierMedical: DossierMedical): Observable<DossierMedical> {
        let copy: DossierMedical = Object.assign({}, dossierMedical);
        copy.datedenaissance = this.dateUtils
            .convertLocalDateToServer(dossierMedical.datedenaissance);
    ...
    find(id: number): Observable<DossierMedical> {
