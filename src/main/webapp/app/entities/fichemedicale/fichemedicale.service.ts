...
export class FichemedicaleService {
    ...
    private resourceUrl = 'api/fichemedicales';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(fichemedicale: Fichemedicale): Observable<Fichemedicale> {
        let copy: Fichemedicale = Object.assign({}, fichemedicale);
    ...
    find(id: number): Observable<Fichemedicale> {
