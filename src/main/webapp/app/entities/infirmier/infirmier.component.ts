...
currentAccount: any;
    ...
    trackId (index: number, item: Infirmier) {
        return item.id;
    }



    registerChangeInInfirmiers() {
        this.eventSubscriber = this.eventManager.subscribe('infirmierListModification', (response) => this.loadAll());
    }
