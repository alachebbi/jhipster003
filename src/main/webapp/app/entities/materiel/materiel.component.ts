...
currentAccount: any;
    ...
    trackId (index: number, item: Materiel) {
        return item.id;
    }



    registerChangeInMateriels() {
        this.eventSubscriber = this.eventManager.subscribe('materielListModification', (response) => this.loadAll());
    }
