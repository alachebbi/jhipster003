...
export class ServicemedicalComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transform(value, term) {
        ...
        return value.filter((servicemedical) => {
    ...
    trackId (index: number, item: Servicemedical) {
        return item.id;
    }
    ...
    registerChangeInServicemedicals() {
        this.eventSubscriber = this.eventManager.subscribe('servicemedicalListModification', (response) => this.loadAll());
    }
