...
var _1 = require("./");
var AvancementAccountModule = (function () {
    function AvancementAccountModule() {
    }
    return AvancementAccountModule;
}());
AvancementAccountModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.AvancementAccountModule = AvancementAccountModule;
