...
var DemandemedicamentvffService = (function () {
    function DemandemedicamentvffService(http, dateUtils) {
        this.http = http;
        this.dateUtils = dateUtils;
        this.resourceUrl = 'api/demandemedicamentvffs';
    }
    ...
    DemandemedicamentvffService.prototype.find = function (id) {
        var _this = this;
    ...
    DemandemedicamentvffService.prototype.query = function (req) {
        var _this = this;
        var options = this.createRequestOption(req);
        return this.http.get(this.resourceUrl, options)
            .map(function (res) { return _this.convertResponse(res); });
    };
    DemandemedicamentvffService.prototype.delete = function (id) {
        return this.http.delete(this.resourceUrl + "/" + id);
    };
    DemandemedicamentvffService.prototype.convertResponse = function (res) {
        var jsonResponse = res.json();
    ...
    DemandemedicamentvffService.prototype.createRequestOption = function (req) {
    ...
    return DemandemedicamentvffService;
}());
DemandemedicamentvffService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, ng_jhipster_1.DateUtils])
], DemandemedicamentvffService);
exports.DemandemedicamentvffService = DemandemedicamentvffService;
//# sourceMappingURL=demandemedicamentvff.service.js.map