...
var EvenementComponent = (function () {
    function EvenementComponent(jhiLanguageService, evenementService, parseLinks, alertService, principal, activatedRoute, dataUtils, router, eventManager, paginationUtil, paginationConfig) {
        var _this = this;
