...
var MedecinService = (function () {
    function MedecinService(http, dateUtils) {
        this.http = http;
        this.dateUtils = dateUtils;
        this.resourceUrl = 'api/medecins';
    }
    MedecinService.prototype.create = function (medecin) {
        var copy = Object.assign({}, medecin);
    ...
    MedecinService.prototype.update = function (medecin) {
        var copy = Object.assign({}, medecin);
        copy.datenaissance = this.dateUtils
            .convertLocalDateToServer(medecin.datenaissance);
    ...
    MedecinService.prototype.find = function (id) {
        var _this = this;
    ...
    MedecinService.prototype.query = function (req) {
        var _this = this;
        var options = this.createRequestOption(req);
        return this.http.get(this.resourceUrl, options)
            .map(function (res) { return _this.convertResponse(res); });
    };
    MedecinService.prototype.delete = function (id) {
        return this.http.delete(this.resourceUrl + "/" + id);
    };
    MedecinService.prototype.convertResponse = function (res) {
        var jsonResponse = res.json();
    ...
    MedecinService.prototype.createRequestOption = function (req) {
    ...
    MedecinService.prototype.printAll = function () {
        return this.http.get('api/doctors/all-doctor.pdf', { responseType: http_1.ResponseContentType.Blob })
            .map(function (resp) {
            return new Blob([resp.blob()], { type: 'application/pdf' });
        });
    };
    MedecinService.prototype.printOne = function (id) {
        return this.http.get(this.resourceUrl + ("/" + id + "/medecin.pdf"), { responseType: http_1.ResponseContentType.Blob })
            .map(function (resp) {
            return new Blob([resp.blob()], { type: 'application/pdf' });
        });
    };
