...
var PatientService = (function () {
    function PatientService(http, dateUtils) {
        this.http = http;
        this.dateUtils = dateUtils;
        this.resourceUrl = 'api/patients';
    }
    ...
    PatientService.prototype.convertResponse = function (res) {
        var jsonResponse = res.json();
    ...
    PatientService.prototype.createRequestOption = function (req) {
