...
var ReclamationService = (function () {
    ...
    ReclamationService.prototype.update = function (reclamation) {
        var copy = Object.assign({}, reclamation);
        return this.http.put(this.resourceUrl, copy).map(function (res) {
            return res.json();
        });
    };
    ReclamationService.prototype.find = function (id) {
        return this.http.get(this.resourceUrl + "/" + id).map(function (res) {
            return res.json();
        });
    };
    ReclamationService.prototype.query = function (req) {
