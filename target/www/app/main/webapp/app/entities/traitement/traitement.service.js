...
var TraitementService = (function () {
    function TraitementService(http) {
        this.http = http;
        this.resourceUrl = 'api/traitements';
    }
    TraitementService.prototype.create = function (traitement) {
        var copy = Object.assign({}, traitement);
        return this.http.post(this.resourceUrl, copy).map(function (res) {
            return res.json();
        });
    };
    TraitementService.prototype.update = function (traitement) {
        var copy = Object.assign({}, traitement);
        return this.http.put(this.resourceUrl, copy).map(function (res) {
            return res.json();
        });
    };
    TraitementService.prototype.find = function (id) {
        return this.http.get(this.resourceUrl + "/" + id).map(function (res) {
            return res.json();
        });
    };
    TraitementService.prototype.query = function (req) {
        var options = this.createRequestOption(req);
        return this.http.get(this.resourceUrl, options);
    };
    TraitementService.prototype.delete = function (id) {
        return this.http.delete(this.resourceUrl + "/" + id);
    };
    TraitementService.prototype.createRequestOption = function (req) {
