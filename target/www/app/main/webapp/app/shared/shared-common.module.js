...
var AvancementSharedCommonModule = (function () {
    function AvancementSharedCommonModule() {
    }
    return AvancementSharedCommonModule;
}());
AvancementSharedCommonModule = __decorate([
    core_1.NgModule({
        imports: [
            _1.AvancementSharedLibsModule
        ],
        declarations: [
...
], AvancementSharedCommonModule);
exports.AvancementSharedCommonModule = AvancementSharedCommonModule;
