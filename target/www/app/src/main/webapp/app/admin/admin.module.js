...
var _1 = require("./");
var AvancementAdminModule = (function () {
    function AvancementAdminModule() {
    }
    return AvancementAdminModule;
}());
AvancementAdminModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.AvancementAdminModule = AvancementAdminModule;
