...
var DemandeService = (function () {
    function DemandeService(http, dateUtils) {
        this.http = http;
        this.dateUtils = dateUtils;
        this.resourceUrl = 'api/demandes';
    }
    DemandeService.prototype.create = function (demande) {
        var copy = Object.assign({}, demande);
        copy.date = this.dateUtils
            .convertLocalDateToServer(demande.date);
        return this.http.post(this.resourceUrl, copy).map(function (res) {
            return res.json();
        });
    };
    DemandeService.prototype.update = function (demande) {
        var copy = Object.assign({}, demande);
        copy.date = this.dateUtils
            .convertLocalDateToServer(demande.date);
    ...
    DemandeService.prototype.find = function (id) {
        var _this = this;
    ...
    DemandeService.prototype.query = function (req) {
        var _this = this;
        var options = this.createRequestOption(req);
        return this.http.get(this.resourceUrl, options)
            .map(function (res) { return _this.convertResponse(res); });
    };
    DemandeService.prototype.delete = function (id) {
        return this.http.delete(this.resourceUrl + "/" + id);
    };
    DemandeService.prototype.convertResponse = function (res) {
        var jsonResponse = res.json();
    ...
    DemandeService.prototype.createRequestOption = function (req) {
