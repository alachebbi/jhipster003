...
var MaterielService = (function () {
    function MaterielService(http, dateUtils) {
        this.http = http;
        this.dateUtils = dateUtils;
        this.resourceUrl = 'api/materiels';
    }
    MaterielService.prototype.create = function (materiel) {
        var copy = Object.assign({}, materiel);
    ...
    MaterielService.prototype.update = function (materiel) {
        var copy = Object.assign({}, materiel);
        copy.dateproduction = this.dateUtils
            .convertLocalDateToServer(materiel.dateproduction);
        copy.datevalidite = this.dateUtils
    ...
    MaterielService.prototype.find = function (id) {
        var _this = this;
    ...
    MaterielService.prototype.query = function (req) {
        var _this = this;
        var options = this.createRequestOption(req);
        return this.http.get(this.resourceUrl, options)
            .map(function (res) { return _this.convertResponse(res); });
    };
    MaterielService.prototype.delete = function (id) {
        return this.http.delete(this.resourceUrl + "/" + id);
    };
    MaterielService.prototype.convertResponse = function (res) {
        var jsonResponse = res.json();
    ...
    MaterielService.prototype.createRequestOption = function (req) {
