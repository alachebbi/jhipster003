...
var TeacherService = (function () {
    function TeacherService(http) {
        this.http = http;
        this.resourceUrl = 'api/teachers';
    }
    TeacherService.prototype.create = function (teacher) {
        var copy = Object.assign({}, teacher);
    ...
    TeacherService.prototype.find = function (id) {
        return this.http.get(this.resourceUrl + "/" + id).map(function (res) {
            return res.json();
        });
    };
    TeacherService.prototype.query = function (req) {
    ...
    TeacherService.prototype.createRequestOption = function (req) {
